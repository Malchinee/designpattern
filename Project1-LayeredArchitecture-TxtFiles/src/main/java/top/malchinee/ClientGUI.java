...
import top.malchinee.decrypt.*;
import top.malchinee.decrypt.impl.DecryptedInfo1;
import top.malchinee.decrypt.impl.DecryptedInfo2;
import top.malchinee.decrypt.impl.DecryptedInfo3;
import top.malchinee.encrypt.*;
import top.malchinee.encrypt.impl.EncryptedInfo1;
import top.malchinee.encrypt.impl.EncryptedInfo2;
import top.malchinee.encrypt.impl.EncryptedInfo3;
...
public class ClientGUI extends JPanel{
   ...
   private static final String CAESARCYPHERENCRYPTION = "CaesarCypher Encryption";
   ...
   public ClientGUI(){
	  ...
	  encryBtn.setMnemonic(KeyEvent.VK_V);
       ...
       decryBtn.setMnemonic(KeyEvent.VK_B);
      ...
      if (e.getActionCommand().equals(ENCRYPT)) {
        ...
        if (e.getActionCommand().equals(DECRYPT)) {
            ...
            if(decryptWay.compareTo(FOLDENCRYPTION)==0)
                info2 = new DecryptedInfo1();
            if(decryptWay.compareTo(BIDIRSHIFTENCRYPTION)==0)
                info2 = new DecryptedInfo2();
            if(decryptWay.compareTo(CAESARCYPHERENCRYPTION)==0)
                info2 = new DecryptedInfo3();

            DecryContext con = new DecryContext(info2);

            con.doDecryption(resultTxt);
        }
    }
